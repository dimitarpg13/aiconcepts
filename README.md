...
There are three topics in Semantic Structures which need work and be completed as I feel those are of importance to the whole idea of semantic simulation by using a dynamical system. Those topics are:
...
Need more work on the energy field based mechanism of guiding semantic structures toward their true semantic position.  
Need more work on the model of attarction and repulsion of semantic structures via semantic association / disassociations. Need to clarify how this mechanism will work together with the energy field based mechanism to synthesize the correct semantic structure after some evolution.
